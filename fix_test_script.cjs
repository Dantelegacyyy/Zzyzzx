...
const reqTests = [
  "AEGIS-T-AST-001", "AEGIS-T-AST-002", "AEGIS-T-AST-003", "AEGIS-T-AST-004", "AEGIS-T-AST-005",
  "AEGIS-T-NONCE-001", "AEGIS-T-NONCE-002",
  "AEGIS-T-OWNER-003", "AEGIS-T-OWNER-004", "AEGIS-T-OWNER-005",
  "AEGIS-T-NETWORK-002", "AEGIS-T-NETWORK-003", "AEGIS-T-NETWORK-004", "AEGIS-T-NETWORK-005",
  "AEGIS-T-RUNTIME-001",
  "AEGIS-T-EVIDENCE-001",
  "AEGIS-T-INTEGRITY-001", "AEGIS-T-INTEGRITY-003", "AEGIS-T-INTEGRITY-004",
  "AEGIS-T-INGESTION-001", "AEGIS-T-INGESTION-002"
];

function runAegisLabTests() {
  console.log("Running AEGIS-LAB Tests...");
  const matrix = Array.from({length: 30}, (_, i) => "AEGIS-LAB-" + String(i+1).padStart(3, '0'));
...
else if (command === 'test:security' || command === 'reconcile:aegis-tests') runSecurityTests();
...
`;
fs.writeFileSync('scripts/aegis/aegis-test-runner.cjs', content);
